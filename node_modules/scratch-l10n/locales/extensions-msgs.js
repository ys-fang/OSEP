...
export default {
  ...
  "en": {
    ...
    "wedo2.whenDistance": "when distance [OP] [REFERENCE]",
    "wedo2.whenTilted": "when tilted [TILT_DIRECTION_ANY]",
    "lass.fetchLASS": "LASS Device [id]",
    "lass.onLASSReceived": "When received data from LAS",
    "lass.parseAttrFromLASS": "LASS read [attr]",
    "lass.readFromLASSErr": "Error： Data does not exist",
    "lass.tempc": "Temperature (C)",
    "lass.humidity": "Humidity"
};
  ...
  "zh-tw": {
    ...
    "lass.fetchLASS": "LASS 設備編號 [id]",
    "lass.onLASSReceived": "當收到 LASS 資料時",
    "lass.parseAttrFromLASS": "LASS 讀取 [attr]",
    "lass.readFromLASSErr": "錯誤： 資料 不存在",
    "lass.tempc": "溫度 C",
    "lass.humidity": "濕度"
