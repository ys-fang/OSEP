...
<tt>options:</tt> 
	...
	<ul class="member-list">
		<h4>Returns:</h4>
			...
			<li>
<tt><a href="../classes/Path.html"><tt>Path</tt></a></tt>&nbsp;&mdash;&nbsp;the reduced path
</li>
...
&mdash;&nbsp;the tangent to which the path must be tangential
	...
	<ul class="member-list">
		<h4>Returns:</h4>
			...
			<li>
<tt>Array of <tt>Numbers</tt></tt>&nbsp;&mdash;&nbsp;path offsets where the path is tangential to the provided tangent
</li>
...
<div class="canvas"><canvas width="516" height="200" id="canvas-105"></canvas></div>
</div>
...
<div class="canvas"><canvas width="516" height="100" id="canvas-107"></canvas></div>
</div>
...
<div class="canvas"><canvas width="516" height="100" id="canvas-108"></canvas></div>
</div>
...
<div class="canvas"><canvas width="516" height="200" id="canvas-109"></canvas></div>
</div>
...
<div class="canvas"><canvas width="516" height="220" id="canvas-112"></canvas></div>
</div>
...
<div class="canvas"><canvas width="516" height="110" id="canvas-113"></canvas></div>
</div>
...
<script type="text/paperscript" canvas="canvas-117">
var path = new Path();
path.strokeColor = 'black';
...
<div class="canvas"><canvas width="516" height="100" id="canvas-117"></canvas></div>
</div>
...
<script type="text/paperscript" canvas="canvas-118">
var myPath;
...
<div class="canvas"><canvas width="516" height="300" id="canvas-118"></canvas></div>
</div>
...
<script type="text/paperscript" canvas="canvas-119">
var myPath;
function onMouseMove(event) {
    // If we created a path before, remove it:
    if (myPath) {
...
<div class="canvas"><canvas width="516" height="300" id="canvas-119"></canvas></div>
</div>
...
<script type="text/paperscript" canvas="canvas-120">
var path = new Path();
path.strokeColor = 'black';
...
<div class="canvas"><canvas width="516" height="100" id="canvas-120"></canvas></div>
</div>
...
<script type="text/paperscript" canvas="canvas-121">
var path = new Path();
path.strokeColor = 'black';
...
<div class="canvas"><canvas width="516" height="300" id="canvas-121"></canvas></div>
</div>
