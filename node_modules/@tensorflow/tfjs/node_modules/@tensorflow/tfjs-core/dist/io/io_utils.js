...
function decodeWeights(buffer, specs) {
    ...
    for (var _i = 0, specs_1 = specs; _i < specs_1.length; _i++) {
        ...
        var value = void 0;
        if (dtype === 'float32') {
            value = tensor_ops_1.TensorOps.tensor(new Float32Array(buffer, offset, size), shape, 'float32');
        }
        else if (dtype === 'int32') {
            value = tensor_ops_1.TensorOps.tensor(new Int32Array(buffer, offset, size), shape, 'int32');
        }
        else if (dtype === 'bool') {
            value =
                tensor_ops_1.TensorOps.tensor(new Uint8Array(buffer, offset, size), shape, 'bool');
        }
        else {
