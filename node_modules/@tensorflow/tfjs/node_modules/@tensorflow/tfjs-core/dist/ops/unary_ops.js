...
var UnaryOps = (function () {
    ...
    UnaryOps.ceil = function (x) {
        ...
        var grad = function (dy) {
            return { $x: function () { return tensor_ops_1.TensorOps.zerosLike(dy); } };
        };
    ...
    UnaryOps.log1p = function (x) {
        ...
        var grad = function (dy) {
            return { $x: function () { return dy.divStrict($x.add(tensor_ops_1.TensorOps.scalar(1))); } };
        };
    ...
    UnaryOps.sqrt = function (x) {
        ...
        var grad = function (dy) {
            return {
                $x: function () { return dy.divStrict($x.toFloat().sqrt().mul(tensor_ops_1.TensorOps.scalar(2))); }
            };
        };
    ...
    UnaryOps.rsqrt = function (x) {
        ...
        var grad = function (dy) {
            return {
                $x: function () {
                    return dy.divStrict($x.pow(tensor_ops_1.TensorOps.scalar(1.5)).mul(tensor_ops_1.TensorOps.scalar(2)))
                        .neg();
                }
            };
        };
    ...
    UnaryOps.square = function (x) {
        ...
        var grad = function (dy) {
            return { $x: function () { return dy.mulStrict($x.toFloat().mul(tensor_ops_1.TensorOps.scalar(2))); } };
        };
    ...
    UnaryOps.clipByValue = function (x, clipValueMin, clipValueMax) {
        ...
        var grad = function (dy) {
            return {
                $x: function () {
                    return dy.where($x.greaterEqual(tensor_ops_1.TensorOps.scalar(clipValueMin))
                        .logicalAnd($x.lessEqual(tensor_ops_1.TensorOps.scalar(clipValueMax))), tensor_ops_1.TensorOps.zerosLike(dy));
                },
            };
        };
    ...
    UnaryOps.sigmoid = function (x) {
        ...
        var grad = function (dy, saved) {
            var y = saved[0];
            return { $x: function () { return dy.mulStrict(y.mul(tensor_ops_1.TensorOps.scalar(1).sub(y))); } };
        };
    ...
    UnaryOps.asin = function (x) {
        ...
        var grad = function (dy) {
            return {
                $x: function () { return dy.divStrict(tensor_ops_1.TensorOps.scalar(1).sub($x.toFloat().square()).sqrt()); }
            };
        };
    ...
    UnaryOps.acos = function (x) {
        ...
        var grad = function (dy) {
            return {
                $x: function () {
                    return dy.divStrict(tensor_ops_1.TensorOps.scalar(1).sub($x.toFloat().square()).sqrt())
                        .neg();
                }
            };
        };
    ...
    UnaryOps.atan = function (x) {
        ...
        var grad = function (dy) {
            return {
                $x: function () { return dy.divStrict(tensor_ops_1.TensorOps.scalar(1).add($x.toFloat().square())); }
            };
        };
    ...
    UnaryOps.tanh = function (x) {
        ...
        var grad = function (dy, saved) {
            var y = saved[0];
            return { $x: function () { return tensor_ops_1.TensorOps.scalar(1).sub(y.square()).mulStrict(dy); } };
        };
    ...
    UnaryOps.asinh = function (x) {
        ...
        var grad = function (dy) {
            return {
                $x: function () { return dy.divStrict(tensor_ops_1.TensorOps.scalar(1).add($x.toFloat().square()).sqrt()); }
            };
        };
    ...
    UnaryOps.acosh = function (x) {
        ...
        var grad = function (dy) {
            return {
                $x: function () { return dy.divStrict($x.toFloat().square().sub(tensor_ops_1.TensorOps.scalar(1)).sqrt()); }
            };
        };
    ...
    UnaryOps.atanh = function (x) {
        ...
        var grad = function (dy) {
            return {
                $x: function () { return dy.divStrict(tensor_ops_1.TensorOps.scalar(1).sub($x.toFloat().square())); }
            };
        };
    ...
    UnaryOps.erf = function (x) {
        ...
        var grad = function (dy) {
            return {
                $x: function () { return dy.mulStrict(tensor_ops_1.TensorOps.scalar(2 / Math.sqrt(Math.PI))
