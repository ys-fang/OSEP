...
var BatchNormOps = (function () {
    ...
    BatchNormOps.batchNormalization = function (x, mean, variance, varianceEpsilon, scale, offset) {
        ...
        var der = function (dy) {
            var scaleValue = $scale == null ? tensor_ops_1.TensorOps.scalar(1) : $scale;
            ...
            var oneOverSqrtVariance = unary_ops_1.UnaryOps.rsqrt($variance.add(tensor_ops_1.TensorOps.scalar(varianceEpsilon)));
            var minusHalfRCube = oneOverSqrtVariance.mul(oneOverSqrtVariance)
                .mul(oneOverSqrtVariance)
                .mul(tensor_ops_1.TensorOps.scalar(-0.5));
            var derX = function () {
                if ($mean.rank === 1) {
                    return dy
            ...
            var derMean = function () {
                var meanDer = oneOverSqrtVariance.mul(tensor_ops_1.TensorOps.scalar(-1))
