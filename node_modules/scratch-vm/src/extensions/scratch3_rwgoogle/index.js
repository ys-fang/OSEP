...
class rwGoogle {
	...
	var gurl = 'https://docs.google.com/forms/d/e/'+googleID+'/formResponse?'
	gurl = gurl + column1_name + "=" + column1_value + "&" + column2_name + "=" + column2_value + "&" + column3_name + "=" + column3_value;
	console.log(gurl);
	fetch(gurl);
	//return fetch(gurl);//.then(res => {
	    //if (res.ok) {
