...
const FormTone = {
    ...
    'zh-tw': '腳位[PIN]播放音調，頻率為[FREQ]時間為[DURATION]微秒',
...
const ContentPort = {
    'en': 'Content to Arduino',
    'zh-tw': '連線到Arduino',
};

const FormOledShow ={
    'en': 'OLED input text [VALUE] at [ROW] row',
    'zh-tw': 'OLED顯示文字[VALUE]在第[ROW]列',
};

const FormdigitalSet = {
    'en': 'digital Pin [PIN] set mode [IN_OUT]',
    'zh-tw': '數位腳位[PIN]設定為[IN_OUT]',
};
...
//dht11
const FormDht11Read = {
    'en': 'Read DHT11 SONAR Pin [PIN]  [TH] Value',
    'zh-tw': '讀取DHT11在腳位 [PIN]，[TH]的值',
};
const MENU_TH_SENSORS ={
...
class Scratch3ArduinoWebSerial {
        ...
        return {
            ...
            blocks: [
                ...
                },
                {
                    opcode: 'digitalSet',
                    blockType: BlockType.COMMAND,
                    text: FormdigitalSet[the_locale],
                    arguments: {
                        PIN: {
                ...
                },
                {
                    ...
                    arguments: {
                        ...
                        TH: {
                            type: ArgumentType.STRING,
                            defaultValue: 'Temperature', //MENU_TH_SENSORS[the_locale][0],
                            menu: 'tem_hum'
                        },
                    }
                },
            ...
            menus: {
                ...
                tone_list: {
                    acceptReporters: true,
                    items: ['C3','CS3','D3','DS3','E3','F3','FS3','G3','GS3','A3','AS3','B3','C4','CS4','D4','DS4','E4','F4','FS4','G4','GS4','A4','AS4','B4','C5','CS5','D5','DS5','E5','F5','FS5','G5','GS5','A5','AS5','B5']
                },
                tem_hum:{
                    acceptReporters: true,
    ...
    // command blocks
    //digitalSet
    async digitalSet(args){
        let pin = args['PIN'];
        let split_pin = pin.split('(');
        //pin = parseInt(pin, 10);
        let in_output = args['IN_OUT'];
        //pinMode(digitalPin, OUTPUT);
        let sendData = 'pinMode#'+split_pin[0]+'#'+in_output;
    ...
    async pwm_write(args) {
        ...
        let sendData = 'analogWrite#'+split_pin[0]+'#'+value;
    ...
    async tone_on(args) {
        ...
        let valueFreq = 0;
        const toneArray1 = ['C1','CS1','D1','DS1','E1','F1','FS1','G1','GS1','A1','AS1','B1','C2','CS2','D2','DS2','E2','F2','FS2','G2','GS2','A2','AS2','B2','C3','CS3','D3','DS3','E3','F3','FS3','G3','GS3','A3','AS3','B3','C4','CS4','D4','DS4','E4','F4','FS4','G4','GS4','A4','AS4','B4','C5','CS5','D5','DS5','E5','F5','FS5','G5','GS5','A5','AS5','B5'];
        ...
        let sendData = 'tonePlay#'+split_pin[0]+'#'+ valueFreq +'#'+duration;
        console.log('sendData:',sendData);
        this.serialSend(sendData);
    ...
    async analog_read(args) {
        //送出pin並取回值
        let pin = args['PIN'].substring(1,1);
    ...
    async dht11_read(args){
        ...
        let sendData = 'dht11Read#'+split_pin[0]+'#'+send_th;
        console.log('sendData:',sendData);
        this.serialSend(sendData);
        return this.serialRead();
    }
